...
function App() {
  ...
  return (
    <main className={isLight ? "App" : "App dark"}>
      ...
      {searchInput === "" ? (
        <section className="to-search">
          <article
            className={
              isLight ? "to-search__content" : "to-search__content dark"
            }
          >
            <h2>Welcome! Find a user by typing their username.</h2>
          </article>
        </section>
      ) : (
        <>
          ...
          >
            <article className="profile-section__card">
              <article className="profile-section__card__info">
                <img
                  className="profile-section__card__info__picture"
                  src={user.avatar_url}
                  alt={user.login}
                />
